...
<a style="margin-left:3%;" href="inputnilai.php">+ Input Nilai</a></br></br>
    ...
    <th>Opsi</th>
                ...
                <?php 
                   ...
                   <tr>
                            ...
                            <td>  
                            <a href="editnilai.php?id=<?php echo $d['id']; ?>">Edit</a>
                            <a style="color: #fc0606;;" href="deletenilai.php?id=<?php echo $d['id']; ?>">Delete</a>
                            </td>
                    </tr>
                   <?php }?>
            </table>
